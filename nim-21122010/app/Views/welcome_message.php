...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Selamat Datang Di Website Rency Vena Kaunang</h1>

        <h2>Ini digunakan untuk menunjukan kompetensi saya dalam menggunakan frameworK HMVC dalam</h2>
        <h2><p>Pengembangan aplikasi web serta mengelola source code menggunakan sistem kontrol versi GIT</h2></p>
    </div>
